...
5. One test: /admin without the password answers 401, and with the password from .env.local lists at least the first decision from the journal. Make the check green.
